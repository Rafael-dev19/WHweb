...
<head>
  ...
  <link rel="stylesheet" href="./assets/<?= av('css/index.css') ?>">
...
<?php endif; ?>
  ...
  <div class="container">
      ...
      <div class="row row-cols-1 row-cols-sm-2 g-4 mb-5">
        <div class="col">
          <div class="contact-card h-100">
            ...
            <h4>WhatsApp</h4>
            <p><a href="<?= siteWhatsappUrl() ?>" target="_blank"><?= SITE_PHONE ?></a></p>
    ...
    <div class="social-section">
      ...
      <div class="d-flex flex-wrap gap-4 justify-content-center social-links">
        ...
        <a href="<?= siteWhatsappUrl('Hola, me interesa una cotización') ?>" class="social-link whatsapp" title="WhatsApp" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="white">
        ...
        <a href="https://www.tiktok.com/@pablowooden?is_from_webapp=1&sender_device=pc" class="social-link tiktok" title="TikTok" target="_blank" rel="noopener noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="white">
  ...
  <footer class="footer">
    ...
    <p style="margin-top:10px; font-size:14px;">
      <a href="mailto:<?= SITE_EMAIL ?>" style="color:#8b7355; text-decoration:none;"><?= SITE_EMAIL ?></a>
    </p>
